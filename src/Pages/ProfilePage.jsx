...
const ProfilePage = () => {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      {/* SIDEBAR */}
      <aside className="w-1/4 bg-white p-8 pl-14">
        <nav className="">

          <div className="border-b border-zinc-200 py-4 hover:bg-zinc-100">
            <NavLink
                to="/hesabim/siparislerim"
                className={({ isActive }) =>
                `flex items-center gap-2 p-3 border-l-3 ${isActive ? "border-black" : "border-transparent"}`
                }>
          ...
          <div className="border-b border-zinc-200 py-4 hover:bg-zinc-100 cursor-pointer">
            <button
                onClick={logOut}
                className="flex items-center gap-2 p-3 border-l-3 border-transparent hover:bg-zinc-100 w-full text-left cursor-pointer">
